...
class HybridHistGBMNumbaV2:
    ...
    def __init__(self, n_estimators='auto', max_depth='auto', learning_rate='auto',
                 ...
                 objective='auto', focal_gamma=2.0, loss='mse'):
...
class HybridHistGBMRegressor(HybridHistGBMNumbaV2):
    """
    ...
    def __init__(self, n_estimators='auto', max_depth='auto', learning_rate='auto',
        ...
        super().__init__(
            ...
            verbose=verbose, random_state=random_state, objective='regression', focal_gamma=2.0, loss=loss
        )


class HybridHistGBMRanker(HybridHistGBMNumbaV2):
    """
